...
BLOG_AUTHOR = "Semut"  # (translatable)
BLOG_TITLE = "BetterSemut"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://semutter.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://semutter.github.io/"
BLOG_EMAIL = "bettersemut@gmail.com"
BLOG_DESCRIPTION = "TO BE A BETTER MAN"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
     ...
     #   ('https://twitter.com/getnikola', 'My Twitter', 'icon-twitter'),
        ('https://github.com/semutter', 'My Github', 'icon-github'),
    )
}
